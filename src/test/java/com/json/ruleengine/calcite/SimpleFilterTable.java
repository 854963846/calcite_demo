 ...
 * @Description
 */
public class SimpleFilterTable extends AbstractTable implements FilterableTable {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ResultSet result = connection.createStatement().executeQuery("SELECT \"id\" FROM \"ft\"" +
                " where \"id\">2");
